...
function showLevel(){
	...
	if(gametype.indexOf('Fruit')>-1) {
		...
		div2.attr('style','position:absolute; top:2px; left:10px;');
		div3.attr('style','position:absolute; top:10px; left:6px; font-size:7px');
		div4.attr('style','position:absolute; top:5px; left:5px; font-size:10px');
